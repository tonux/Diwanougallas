...
class EvenementsControllerTest < ActionController::TestCase
  ...
  test "should create evenement" do
    assert_difference('Evenement.count') do
      post :create, evenement: { date_event: @evenement.date_event, desc: @evenement.desc, lieu: @evenement.lieu, title: @evenement.title }
    end
  ...
  test "should update evenement" do
    put :update, id: @evenement, evenement: { date_event: @evenement.date_event, desc: @evenement.desc, lieu: @evenement.lieu, title: @evenement.title }
    assert_redirected_to evenement_path(assigns(:evenement))
  end
